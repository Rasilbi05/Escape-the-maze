...
//===== Direcci�n de conmienzo del framebuffer =================================

#define GLCD_VRAM_BASE_ADDR (SDRAM_BASE + 0x0010000)

//===== Tama�o en pixels del LCD ===============================================
...
//===== Configuraci�n del controlador de LCD ====================================
...
/** Frecuencia de la polarizac�n AC (no se usa). */
#define AC_BIAS             1u

/** Invertir sincronismo horizontal (0 => No, 1 => S�). */  
#define INVERT_H_SYNC       1u

/** Invertir sincronismo vertical (0 => No, 1 => S�). */
#define INVERT_V_SYNC	      1u

/** Invertir reloj de pixels (0 => No, 1 => S�). */
...
#define OPTIMAL_CLOCK       (9*1000000) /* Reloj �ptimo, entre 1 y 8.22 MHz */
...
//----- Nombres de varios colores en ingl�s ------------------------------------
...
//----- Nombres de varios colores en espa�ol -----------------------------------
